...
<section class="p-16 mb-64 bg-gray-50">
    <div class="grid grid-cols-[1fr_2fr] gap-6">
        <div class="bg-white p-0 rounded-xl shadow aspect-video">
            ...
            <a href="index.php?page=payment/topup&id=<?= $_GET['id'] ?>"><button class="px-6 py-2 m-2 rounded-full bg-blue-600 text-white hover:bg-blue-400">Top Up</button></a>
        ...
        <div class="bg-white p-6 rounded-xl shadow">
            ...
            <div class="mt-5 text-center ml-20 mr-20 pl-10 pr-10">
                <p>Purchase this course for Rp<?= number_format($data_course['course_cost'], 0, ',', '.') ?>?</p>
                <div class="grid grid-cols-2">
                    ...
                    <a href="index.php?page=course/detail&id=<?= $_GET['id'] ?>"><button class="px-6 py-2 mt-2 rounded-full bg-gray-500 text-white hover:bg-blue-400">Cancel</button></a>
                </div>
            </div>
        </div>
    </div>
