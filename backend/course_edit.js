document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.change-file-btn').forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            sectionItem.querySelector('.current-file-area').classList.add('hidden');
            sectionItem.querySelector('.section-upload-area').classList.remove('hidden');
            sectionItem.querySelector('.keep-current-file').value = '0';
        });
    });
